...
3. **Сортировка подмассивов (Bubble Sort)**  
...
4. **Слияние отсортированных подмассивов**  
...
Разделяемая память особенно эффективна для редукции и слияния подмассивов.

Локальная память ускоряет сортировку внутри потоков.

Для больших массивов (100 000 и 1 000 000 элементов) выигрыш меньше, так как накладные расходы на запуск CUDA-ядр и атомарные операции начинают влиять на общую производительность.
